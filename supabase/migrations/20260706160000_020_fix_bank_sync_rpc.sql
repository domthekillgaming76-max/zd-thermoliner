-- 020_fix_bank_sync_rpc.sql
-- Ensures sync_validated_road_sheets_bank() exists and PostgREST schema cache can see it.
...
COMMENT ON FUNCTION public.sync_validated_road_sheets_bank() IS
  'Backfill validated road_sheets into bank transactions without duplicates.';
