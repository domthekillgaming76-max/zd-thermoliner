...
export type ModuleKey =
  ...
  | 'driver_integrations' | 'client_launcher' | 'events' | 'join' | 'clovis_rental' | 'meals' | 'truck_shop';
...
export const ROUTE_MODULE_RULES: { prefix: string; module: ModuleKey }[] = [
  ...
  { prefix: '/clovis-rental', module: 'clovis_rental' },
  { prefix: '/meals', module: 'meals' },
  { prefix: '/truck-shop', module: 'truck_shop' },
